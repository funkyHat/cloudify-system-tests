...
class Executor(object):
    ...
    def __call__(self, workdir, command,
                 path_prepends=None, env_var_overrides=None,
        ...
        if cache_file is None:
            ...
            cache_file = self._generate_dotfile(workdir, command, os_env)
    ...
    def _generate_dotfile(self, workdir, command, env):
        ...
        env_file_path = os.path.join(workdir, candidate_filename)
